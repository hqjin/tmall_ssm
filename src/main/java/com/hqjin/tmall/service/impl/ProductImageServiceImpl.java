...
import com.hqjin.tmall.mapper.ProductImageMapper;
import com.hqjin.tmall.pojo.ProductImage;
import com.hqjin.tmall.pojo.ProductImageExample;
...
//犯错：总是忘记implements继承接口的操作。因为applicationContext.xml中，component-scan指定的是service的包。
@Service
