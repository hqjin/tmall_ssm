...
<body>
    <div class="workingArea">
        <ol class="breadcrumb">
            ...
            <li><a class="active">${p.name}</a> </li>
            <li><a class="active">产品图片管理</a> </li>
        </ol>
                    ...
                    <div>
                        <div class="panel panel-warning addPictureDiv">
                            ...
                            <div class="panel-body">
                                <form method="post" enctype="multipart/form-data" class="addFormSingle"
                        ...
                        <table class="table table-bordered table-hover table-condensed table-striped">
                            ...
                            <c:forEach items="${pisSingle}" var="pi">
                                <tr>
                                    <td>${pi.id}</td>
                                    <td><a title="点击查看图片" href="img/productSingle/${pi.id}.jpg">
