                ...
                <tr class="orderListItemFirstTR">
                    ...
                    <td class="orderItemDeleteTD">
                        <a href="#nowhere" oid="${o.id}" class="deleteOrderLink">
                            <span class="glyphicon glyphicon-trash orderListItemDelete"></span>
                        </a>
                    </td>
                </tr>
                <c:forEach items="${o.orderItems}" var="oi" varStatus="st">
                    <tr class="orderItemProductInfoPartTR">
                        <td class="orderItemProductInfoPartTD">
                            <img height="80" width="80" src="img/productSingle_middle/${oi.product.firstProductImage.id}.jpg">
                        </td>
                        <td class="orderItemProductInfoPartTD">
                        ...
                        <td class="orderItemProductInfoPartTD" width="100px">
                            <div class="orderListItemProductOriginalPrice">
                                ￥<fmt:formatNumber type="number" minFractionDigits="2" value="${oi.product.originalPrice}"></fmt:formatNumber>
                            </div>
                            <div class="orderListItemProductPrice">
                                ￥<fmt:formatNumber type="number" minFractionDigits="2" value="${oi.product.promotePrice}"></fmt:formatNumber>
                            </div>
                        </td>
                        <c:if test="${st.count==1}">
                            ...
                            <td valign="top" rowspan="${fn:length(o.orderItems)}"
                                class="orderItemOrderInfoPartTD orderListItemProductRealPriceTD" width="120px">
                                <div class="orderListItemProductRealPrice">
                                    ￥<fmt:formatNumber type="number" minFractionDigits="2" value="${o.total}"></fmt:formatNumber>
                                </div>
                                <div class="orderListItemPriceWithTransport">（含运费：￥0.00）</div>
                            </td>
                            <td valign="top" rowspan="${fn:length(o.orderItems)}"
                                class="orderItemOrderInfoPartTD orderListItemButtonTD" width="100px">
