                ...
                <tr oiid="${oi.id}" class="cartProductItemTR">
                    ...
                    <td>
                        <div class="cartProductLinkOutDiv">
                            <a href="foreproduct?pid=${oi.pid}" class="productLink">${oi.product.name}</a>
                    ...
                    <td>
                        <span class="cartProductItemSmallSumPrice" pid="${oi.pid}" oiid="${oi.id}">
                            ￥<fmt:formatNumber type="number" minFractionDigits="2" value="${oi.product.promotePrice*oi.number}"></fmt:formatNumber>
                        </span>
                    </td>
                    <td>
