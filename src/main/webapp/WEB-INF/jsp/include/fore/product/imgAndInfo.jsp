...
<script>
    $(function () {
        ...
        //用了JQuery的get方法，异步ajax的方式访问forecheckLogin
    ...
    <div class="infoInimgAndInfo">
        ...
        <div class="productPrice">
            <div class="juhuasuan">
                ...
                <span>此商品参加聚划算<span class="juhuasuanTime">1天17小时</span>后开始 </span>
            </div>
            <div class="productPriceDiv">
                ...
                <div class="promotionDiv">
                    ...
                    <span class="promotionPrice">
                        <fmt:formatNumber type="number" minFractionDigits="2" value="${p.promotePrice}"></fmt:formatNumber>
                    </span>
                </div>
            </div>
